      ...
      <View style={styles.container}>
        <StatusBar animated={true} backgroundColor="#0b3155" />
          ...
          style={{
            ...
            <Text style={{color: '#fff', textAlign: 'center', fontSize: 18, fontWeight: "bold"}}>Resultats en fonction de localisation</Text>
        </View>
        ...
        <ScrollView>
            ...
            style={{
                ...
                <Text><Text style={{color: '#fff', textAlign: 'center', fontSize: 18, fontWeight: "bold"}}>Voir sur la carte</Text></Text>
            </TouchableOpacity>
            <View>
